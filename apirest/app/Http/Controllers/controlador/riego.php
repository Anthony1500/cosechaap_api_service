...
switch ($op) { 
    case 'select':
        ...
        $condicion=$condicion."where riego_fecha like '%".$filtro."%' OR propi_id like '%".$filtro."%'OR riego_dias like '%".$filtro."%'OR riego_horas like '%".$filtro."%'OR riego_observaciones like '%".$filtro."%' ";
            ...
            $resultqry = mysqli_query($con,"SELECT * from riego".$condicion." ORDER BY riego_fecha ASC;" );
            if (!$resultqry) {
    ...
    $mensaje = "";
        $response = array( 
            ...
            try{
                ...
                $sql = "INSERT INTO riego (propi_id,riego_dias,riego_horas,riego_fecha,prop_nombre,prop_apellido,riego_observaciones) 
                VALUES ('$propi_id','$riego_dias','$riego_horas','$riego_fecha','$prop_nombre','$prop_apellido','$riego_observaciones')"; 
